...
index_ethreg <- (Q82Aunit + Q82Bunit + Q82Cunit + Q82Dunit + Q84Bunit + Q84Cunit +Q86Aunit + Q86Bunit)/8
...
#For ethreg
cethreg <- felm(index_ethreg ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = df)
...
cindexoverall <- felm(cohesion_index ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude | Country + Year| 0 | Country, data = df)
cindexmen <- felm(cohesion_index ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude | Country + Year| 0 | Country, data = dfmen)
cindexwomen <- felm(cohesion_index ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude | Country + Year| 0 | Country, data = dfwomen)
...
cintramen <- felm(index_intra ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfmen)
cintrawomen <- felm(index_intra ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfwomen)

cethregmen <- felm(index_ethreg ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfmen)
cethregwomen <- felm(index_ethreg ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfwomen)

ceconomicmen <- felm(index_economic ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfmen)
ceconomicwomen <- felm(index_economic ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfwomen)

cauthoritymen <- felm(index_authority ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfmen)
cauthoritywomen <- felm(index_authority ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfwomen)
...
cindexoverall <- felm(cohesion_index ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude | Country + Year| 0 | Country, data = df)
cindexheduc <- felm(cohesion_index ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude | Country + Year| 0 | Country, data = dfheduc)
cindexleduc <- felm(cohesion_index ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude | Country + Year| 0 | Country, data = dfleduc)
stargazer(cindexoverall, cindexheduc, cindexleduc, title = "Fixed Effects Models using felm", align = TRUE, out="cindexeducation.txt")

#Doing this for subindices

cintraheduc <- felm(index_intra ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfheduc)
cintraleduc <- felm(index_intra ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfleduc)

cethregheduc <- felm(index_ethreg ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfheduc)
cethregleduc <- felm(index_ethreg ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfleduc)

ceconomicheduc <- felm(index_economic ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfheduc)
ceconomicleduc <- felm(index_economic ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfleduc)

cauthorityheduc <- felm(index_authority ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfheduc)
cauthorityleduc <- felm(index_authority ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfleduc)
...
cindexoverall <- felm(cohesion_index ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude | Country + Year| 0 | Country, data = df)
cindexhinc <- felm(cohesion_index ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude | Country + Year| 0 | Country, data = dfhinc)
cindexlinc <- felm(cohesion_index ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude | Country + Year| 0 | Country, data = dflinc)
stargazer(cindexoverall, cindexhinc, cindexlinc, title = "Fixed Effects Models using felm", align = TRUE, out="cindexincome.txt")

#Doing this for subindices

cintrahinc <- felm(index_intra ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfhinc)
cintralinc <- felm(index_intra ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dflinc)

cethreghinc <- felm(index_ethreg ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfhinc)
cethreglinc <- felm(index_ethreg ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dflinc)

ceconomichinc <- felm(index_economic ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfhinc)
ceconomiclinc <- felm(index_economic ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dflinc)

cauthorityhinc <- felm(index_authority ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfhinc)
cauthoritylinc <- felm(index_authority ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dflinc)
...
Q8Bunitmen <- felm(Q8Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfmen)
Q8Bunitwomen <- felm(Q8Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfwomen)

Q86Bunitmen <- felm(Q86Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfmen)
Q86Bunitwomen <- felm(Q86Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfwomen)

Q84Aunitmen <- felm(Q84Aunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfmen)
Q84Aunitwomen <- felm(Q84Aunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfwomen)

Q41Gunitmen <- felm(Q41Gunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfmen)
Q41Gunitwomen <- felm(Q41Gunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfwomen)
...
Q8Bunitheduc <- felm(Q8Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfheduc)
Q8Bunitleduc <- felm(Q8Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfleduc)

Q86Bunitheduc <- felm(Q86Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfheduc)
Q86Bunitleduc <- felm(Q86Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfleduc)

Q84Aunitheduc <- felm(Q84Aunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfheduc)
Q84Aunitleduc <- felm(Q84Aunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfleduc)

Q41Gunitheduc <- felm(Q41Gunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfheduc)
Q41Gunitleduc <- felm(Q41Gunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfleduc)
...
Q8Bunithinc <- felm(Q8Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfhinc)
Q8Bunitlinc <- felm(Q8Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dflinc)

Q86Bunithinc <- felm(Q86Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfhinc)
Q86Bunitlinc <- felm(Q86Bunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dflinc)

Q84Aunithinc <- felm(Q84Aunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfhinc)
Q84Aunitlinc <- felm(Q84Aunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dflinc)

Q41Gunithinc <- felm(Q41Gunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dfhinc)
Q41Gunitlinc <- felm(Q41Gunit ~ Occurrence + Occurrence:DaysSinceDisaster + Occurrence:Log_TotalAffected + Occurrence:Log_Magnitude| Country + Year| 0 | Country, data = dflinc)
